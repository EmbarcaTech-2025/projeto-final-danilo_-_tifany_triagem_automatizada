...
static i2c_inst_t *i2c_bus = i2c1;
...
#else
    i2c_write_blocking(i2c_bus,i2cAddress,&ucAddr,1,true);
    i2c_read_blocking(i2c_bus,i2cAddress,ucTemp,2,false);
#endif
...
#else
    i2c_write_blocking(i2c_bus,i2cAddress,&ucAddr,1,true);
    i2c_read_blocking(i2c_bus,i2cAddress,&ucTemp,1,false);
#endif
...
#else
   i2c_write_blocking(i2c_bus,i2cAddress,&ucAddr,1,true);
   i2c_read_blocking(i2c_bus,i2cAddress,pBuf,iCount,false);
#endif
} /* readMulti() */
...
int rc;
	...
	if (rc != iCount+1) {};
#else
   i2c_write_blocking(i2c_bus,i2cAddress,ucTemp,iCount+1,false);
#endif
} /* writeMulti() */
//
...
#else
   i2c_write_blocking(i2c_bus,i2cAddress,ucTemp,3,false);
#endif
...
#else
   i2c_write_blocking(i2c_bus,i2cAddress,ucTemp,2,false);
#endif
...
int rc;
	while (ucCount)
	{
		...
		if (rc != 2) {};
#else
       i2c_write_blocking(i2c_bus,i2cAddress,ucList,2,false);
#endif
		ucList += 2;
		ucCount--;
	}
